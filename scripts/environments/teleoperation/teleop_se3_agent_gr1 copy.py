...
def get_image(env):
    ...
    img = rgb_data[0].cpu().numpy()  # Shape: (H, W, 3)gr1t2
...
def main() -> None:
    ...
    def reset_recording_instance() -> None:
        ...
        nonlocal visionpro_client
        should_reset_recording_instance = True
        visionpro_client.send_command("Resetting Teleoperation")
    ...
    def start_teleoperation() -> None:
        ...
        visionpro_client.send_command("Starting Teleoperation")
    ...
    def stop_teleoperation() -> None:
        ...
        nonlocal visionpro_client
        teleoperation_active = False
        visionpro_client.send_command("Stoping Teleoperation")
        print("Teleoperation Deactivated")
    
    def save_and_reset__teleoperation() -> None:
        nonlocal should_reset_recording_instance
        nonlocal visionpro_client
        should_reset_recording_instance = True
        visionpro_client.send_command("Saving and Resetting Teleoperation")
        print("Save & Reset triggered - Environment will reset on next step")

    teleoperation_callbacks = {
        "RESET": reset_recording_instance,
        "PLAY": start_teleoperation,
        "START": start_teleoperation,
        "STOP": stop_teleoperation,
        "SAVE": save_and_reset__teleoperation,
    }
