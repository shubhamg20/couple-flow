...
class EpisodeSaver:
    ...
    def __init__(self, task_name: str):
        ...
        self.task_dir = Path(f"source/recorded_runs/{task_name}")
...
class RecordingManager:
    ...
    def _get_next_episode_number(self) -> int:
        ...
        task_dir = Path(f"source/recorded_runs/{self.task_name}")
...
class TeleoperationCallbacks:
    ...
    def __init__(self, env, recording_manager: RecordingManager):
        self.env = env
...
def main() -> None:
    ...
    callback_manager = TeleoperationCallbacks(env, recording_manager)
