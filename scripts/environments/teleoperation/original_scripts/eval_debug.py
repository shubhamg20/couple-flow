...
#/home/weirdlab/Documents/summers/IsaacLab/source/couple-flow-policy
...
from dino.configs_dino import FlowMatchingModelRunConfig
from dino.make_networks_dino import instantiate_flow_matching_artifacts
from dino.dataset_dino_zarr import IsaacLabDataset
...
#🤖🤖🤖🤖🤖🤖🤖🤖🤖🤖🤖🤖🤖🤖🤖🤖🤖🤖
#🤖🤖🤖🤖🤖🤖🤖🤖🤖🤖🤖🤖🤖🤖🤖🤖🤖🤖
TRAIN_DATASET_PATH = "source/couple-flow-policy/dino/dataset/validation.pkl"  #required to extract stats
VAL_DATASET_PATH = "source/couple-flow-policy/dino/dataset/validation.pkl"
...
def main():
    ...
    # episode_indices = np.array([4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4,4])
    ################################################################################
