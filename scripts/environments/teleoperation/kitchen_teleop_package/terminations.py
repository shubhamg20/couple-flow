...
def object_touching_tray(
    ...
    # Static tray position (same for all envs). Avoid get_world_poses() so multi-env works (tray may have 1 prim).
    tray_pos = torch.tensor([0.41, 0.42, 1.0], device=env.device)
